...
struct _parser_error_desc parser_error_desc[] = {
    ...
    { E_PARSER_MAN_ERROR, "Unable to run or close man stream" },
    { E_PARSER_INVALID_PARAM, "Invalid parameter(s) passed to the function" },
    { E_PARSER_TRUNC, "The buffer could not hold all the section data." },
